...
const Header = () => {
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-success shadow-sm border-light">
        <div className="container-fluid py-1">
          ...
          >
            ...
            <ul className="kkk navbar-nav ms-2 me-2 px-2 mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <NavLink className="nav-link text-light fw-bold" to="/product">
            ...
            <NavLink className="login text-black" to="/login">
              Login
            </NavLink>
            ...
            <div className="">
              <NavLink
                to="/cart"
                className="btn btn-outline-dark rounded-pill ms-2"
              >
