    ...
    return (
      <div class="card border-1 my-4 py-3" style={{ width: " 18rem" }}>
        ...
        <div class="card-body text-center">
          ...
          <p className="lead card-text text-success">{item.price}</p>
          <a href="/BuyNow" class="btn btn-outline-success rounded-pill">
            Buy now
          </a>
      ...
      <div className="container mt-5 py-0">
        <div className="row">
          <div className="col-12 text-center">
            <h1 className="fw-bold text-success">PRODUCT</h1>
            <hr />
          </div>
        </div>
      </div>
